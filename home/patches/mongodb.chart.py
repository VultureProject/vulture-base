...
class Service(SimpleService):
    def __init__(self, configuration=None, name=None):
        ...
        self.ssl_cert = self.configuration.get('ssl_cert')
        self.ssl_ca = self.configuration.get('ssl_ca')
    ...
    def _create_connection(self):
        ...
        if self.uri:
            try:
                connection = MongoClient(self.uri, ssl_ca_certs=self.ssl_ca, ssl_certfile=self.ssl_cert)
